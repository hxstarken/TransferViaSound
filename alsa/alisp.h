...
struct alisp_cfg
{
	int verbose :1, warning :1, debug :1;
...
int alsa_lisp_function(struct alisp_instance *instance,
		struct alisp_seq_iterator **result, const char *id, const char *args,
		...)
#ifndef DOC_HIDDEN
...
int alsa_lisp_seq_pointer(struct alisp_seq_iterator *seq, const char *ptr_id,
		void **ptr);
