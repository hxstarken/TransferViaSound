...
typedef enum _snd_rawmidi_stream
{
	...
	/** Input stream */
	SND_RAWMIDI_STREAM_INPUT, SND_RAWMIDI_STREAM_LAST = SND_RAWMIDI_STREAM_INPUT
...
int snd_rawmidi_poll_descriptors_revents(snd_rawmidi_t *rawmidi,
		struct pollfd *pfds, unsigned int nfds, unsigned short *revent);
...
int snd_rawmidi_params_set_no_active_sensing(snd_rawmidi_t *rmidi,
		snd_rawmidi_params_t *params, int val);
