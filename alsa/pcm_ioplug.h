...
struct snd_pcm_ioplug_callback
{
	 ...
	 */
	int (*poll_descriptors)(snd_pcm_ioplug_t *io, struct pollfd *pfd,
			unsigned int space);
	/**
...
const snd_pcm_channel_area_t *snd_pcm_ioplug_mmap_areas(
...
int snd_pcm_ioplug_set_param_minmax(snd_pcm_ioplug_t *io, int type,
		unsigned int min, unsigned int max);
int snd_pcm_ioplug_set_param_list(snd_pcm_ioplug_t *io, int type,
